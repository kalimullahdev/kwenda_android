...
public class Payment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        backArrow.setOnClickListener(view -> GoToMainActivity());
    ...
    public void getCardList() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URLHelper.CARD_PAYMENT_LIST, response -> {
