...
import com.kwendaapp.rideo.Constants.PlacesAutoCompleteAdapter;
...
//        });
    ...
    public void findViewByIdAndInitialize() {
        ...
        if (!SharedHelper.getKey(context, "currentAddress").equals("") || SharedHelper.getKey(context, "currentAddress") != null) {
