...
public class MapRipple {
    ...
    private final ValueAnimator[] vAnimators;
    private final Handler[] handlers;
    private final GroundOverlay[] gOverlays;
    ...
    public MapRipple(GoogleMap googleMap, LatLng latLng, Context context) {
        ...
        drawable = (GradientDrawable) ContextCompat.getDrawable(context, R.drawable.background);
    ...
    private void OverLay(final int i) {
        ...
        vAnimators[i].addUpdateListener(valueAnimator -> {
