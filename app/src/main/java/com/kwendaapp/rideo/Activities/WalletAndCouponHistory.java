...
import com.kwendaapp.rideo.Fragments.CouponHistory;
import com.kwendaapp.rideo.Fragments.WalletHistory;
...
public class WalletAndCouponHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] tabTitles = new String[]{getResources().getString(R.string.walletHistory),
    ...
    private void setupTabIcons() {
        ...
        @SuppressLint("InflateParams") TextView tabOne = (TextView) LayoutInflater.from(WalletAndCouponHistory.this).inflate(R.layout.custom_tab, null);
        tabOne.setText(getResources().getString(R.string.walletHistory));
        tabLayout.getTabAt(0).setCustomView(tabOne);


        @SuppressLint("InflateParams") TextView tabTwo = (TextView) LayoutInflater.from(WalletAndCouponHistory.this).inflate(R.layout.custom_tab, null);
